...
void tim3_init(void) {
	...
	timer_set_repetition_counter(TIM3, 0); //disabled, only valid for advanced timers (TIM1 and TIM8)
...
/*    printf("a teR: %d teL: %d EncSR: %f EncSL: %f error_r: %f i_pid_error_r: %f pi_control_r: %f error_l: %f i_pid_error_l: %f pi_control_l: %f duty_r %f duty_l %f\n", rpos, rneg, totalencoderR, encoderR, totalencoderL, encoderL, encoder_speed_r, encoder_speed_l, pid_error_r, i_pid_error_r, pi_control_r, pid_error_l, i_pid_error_l, pi_control_l, duty_r, duty_l);*/
