...
def central_coord(image_width, image_height):
	central_coord = image_width/2 , image_height/2
	return central_coord
	
coordenada_central =  central_coord(image_width, image_height)

 # punto central de una imagen de resolucion 1280x768
